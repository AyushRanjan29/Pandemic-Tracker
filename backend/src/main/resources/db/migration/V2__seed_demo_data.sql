...
INSERT IGNORE INTO virus_strain (id, who_label, pango_lineage, common_name, first_detected_on, risk_level, transmissibility_factor, immune_escape_score) VALUES
...
INSERT IGNORE INTO infection_log (id, location_id, strain_id, observed_at, new_cases, active_cases, recoveries, deaths, test_count, positivity_rate, source_infection_log_id, source_confidence) VALUES
    (1, 6, 1, '2026-05-10 08:00:00', 47, 120, 12, 1, 900, 5.22, NULL, NULL),
    (2, 4, 1, '2026-05-14 08:00:00', 28, 88, 9, 0, 700, 4.00, 1, 82.50),
    (3, 5, 1, '2026-05-18 08:00:00', 16, 49, 5, 0, 420, 3.81, 2, 76.00),
    (4, 4, 1, '2026-05-23 08:00:00', 54, 144, 14, 1, 1100, 4.91, 2, 88.00);
...
INSERT IGNORE INTO hospital_inventory (hospital_location_id, recorded_at, total_beds, available_beds, icu_beds, available_icu_beds, ventilators, available_ventilators, oxygen_cylinders, available_oxygen_cylinders, updated_by) VALUES
    (7, '2026-05-24 07:00:00', 300, 82, 42, 11, 30, 9, 250, 180, 'ops-admin'),
    (8, '2026-05-24 07:00:00', 220, 44, 30, 6, 18, 5, 180, 104, 'ops-admin'),
    (9, '2026-05-24 07:00:00', 160, 67, 18, 8, 12, 6, 120, 88, 'ops-admin'),
    (10, '2026-05-24 07:00:00', 480, 38, 80, 7, 60, 8, 320, 96, 'ops-admin');
...
INSERT IGNORE INTO vaccine_inventory (hospital_location_id, vaccine_name, manufacturer, dose_count, reserved_dose_count, recorded_at, expires_on, updated_by) VALUES
    (7, 'PanVax Booster', 'National Biologics', 1200, 160, '2026-05-24 07:00:00', '2026-10-31', 'pharmacy'),
    (8, 'PanVax Booster', 'National Biologics', 640, 80, '2026-05-24 07:00:00', '2026-11-15', 'pharmacy'),
    (9, 'PanVax Booster', 'National Biologics', 720, 50, '2026-05-24 07:00:00', '2026-12-01', 'pharmacy'),
    (10, 'PanVax Booster', 'National Biologics', 360, 70, '2026-05-24 07:00:00', '2026-09-30', 'pharmacy');

ALTER TABLE location AUTO_INCREMENT = 11;
ALTER TABLE virus_strain AUTO_INCREMENT = 2;
ALTER TABLE infection_log AUTO_INCREMENT = 5;
